...
gulp.task('serve', function(callback) {
    runSequence(['deploy-dev-test:copyLiveHtml','install-dev:compile-sass','deploy-dev-test:copy-styles-scripts'],callback);
    bSync.init({
